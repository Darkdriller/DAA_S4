...
def outPut(model,iter):
    work=xlsxwriter.Workbook('result_GA{}.xlsx'.format(iter))
...
def run(filepath,epochs,pc,pm,popsize,n_select,v_cap,opt_type,iter):
    """
...
if __name__=='__main__':
    ...
    res=[]
    for i in range(10):
        res.append(run(filepath=file,epochs=150,pc=0.6,pm=0.2,popsize=100,n_select=80,v_cap=80,opt_type=1,iter=i))
    plotObj(res)
